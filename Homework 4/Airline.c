...
TCES201
Autumn 2014
This program prompts the user to choose a seat, or check the seat chart, or exit. Then it will check to see if the section is full,
or if the seat is full, if it is it will return an error. Then it will print a boarding pass with the name, seat number and seat
type that the user has chosen. If all seats are full it will display "The next flight leaves in 3 hours".
*/
